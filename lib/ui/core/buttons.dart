...
Widget iconButtonPreview() => IconButton(icon: Icon(Symbols.add), onPressed: () {});

@Preview(name: "Icon Button - Outlined", group: "Buttons", textScaleFactor: 1.5, background: true)
Widget outlinedIconButtonPreview() => IconButton.outlined(icon: Icon(Symbols.add), onPressed: () {});

@Preview(name: "Icon Button - Filled", group: "Buttons", textScaleFactor: 1.5, background: true)
Widget filledIconButtonPreview() => IconButton.filled(icon: Icon(Symbols.add), onPressed: () {});

@Preview(name: "Icon Button - Filled Tonal", group: "Buttons", textScaleFactor: 1.5, background: true)
Widget filledTonalIconButtonPreview() => IconButton.filledTonal(icon: Icon(Symbols.add), onPressed: () {});
